...
import (
	...
	"yaml2json/restapi/operations"
)

//go:generate swagger generate server --target ../../app --name Yaml2json --spec ../swagger.yaml --principal interface{}

func configureFlags(api *operations.Yaml2jsonAPI) {
...
func configureAPI(api *operations.Yaml2jsonAPI) http.Handler {
